    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           String qry;
           qry = "insert into AddressBook values ('"+person.getName()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getCity()+"','"+person.getState()+"')";
           st.executeUpdate(qry);
           System.out.println(" dao addperson"+qry);
           conn.close();
        }
    ...
    @Override
     public void updatePerson(Person person,String name)
     {
         try
       {
           conn = DBConnection.getInstance().getConnect();
           st = conn.createStatement();
            String qry="update AddressBook set name='"+person.getName()+"',mob='"+person.getMob()+"',email='"+person.getEmail()+"',city='"+person.getCity()+"',State='"+person.getState()+"' where name='"+name+"'";
           st.executeUpdate(qry);
           conn.close();
        }
